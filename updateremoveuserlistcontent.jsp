...
<center><table border="0" width="60%" cellspacing="0" cellpadding="0">
    <tr>
	  ...
	  <logic:present name="hasPrev">
        <p align="right"><font face="Tahoma" size="2"><a href="updateremoveuserlist.do?SP=<%=SP-DBInfo.PAGE_SIZE%><%=added%>" class="two">&lt;&lt;
        Prev</a></font>
	  </logic:present>
	  </td>
      <td width="5%"></td>
	  ...
	  <logic:present name="hasNext">
        ...
        <p align="left"><font face="Tahoma" size="2"><a href="updateremoveuserlist.do?SP=<%=SP+DBInfo.PAGE_SIZE%><%=added%>" class="two">Next
        &gt;&gt;</a></font>
	  </logic:present>
	  </td>
      <td width="20%"></td>
